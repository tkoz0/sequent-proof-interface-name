// original name, changed to be something people can say comfortably
//export const APP_TITLE_LONG = "Proof Interface for Sequent Systems";
...
export const ENABLE_PARSER_TEST = false; // for debugging purposes
